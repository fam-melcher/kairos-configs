...
#cloud-config
# Generated by dispatch.sh from the cluster's 11-cluster.yaml values
# file (ADR 0013). Do not edit on the node; change the values in the
